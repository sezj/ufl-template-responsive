...
/* 
 * To ensure compatability, it is recommended you maintain class, id and form name attributes, unless you know what you're doing. 
...
<form enctype='multipart/form-data' id="event-form" method="post" action="<?php echo esc_url(add_query_arg(array('success'=>null))); ?>">
	<div class="wrap">
		...
		<?php endif; ?>
		<h3 class="event-form-name"><?php esc_html_e( 'Event Name', 'dbem' ); ?><?php echo $required; ?></h3>
		<div class="inside event-form-name">					
			...
			<p><em><?php esc_html_e('Example: Information Session', 'dbem'); ?></em></p>
			<?php em_locate_template('forms/event/group.php',true); ?>

		</div>
					
		<h3 class="event-form-when"><?php esc_html_e( 'Date and Time', 'dbem' ); ?></h3>
		...
		<h3 class="event-form-where"><?php esc_html_e( 'Location', 'dbem' ); ?></h3>
		...
		<div class="inside event-form-details">
			<div class="event-editor">
				...
				<?php else: ?>
					<textarea name="content" rows="10"><?php echo $EM_Event->post_content ?></textarea>
