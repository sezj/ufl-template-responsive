...
if ( function_exists ('register_sidebar')) { 
		...
		register_sidebar (array(
			'name' => 'Home Page Features Footer',
			'id' => 'featurebox_footer',
			'description' => 'Widgets in this area will be shown in the FEATURES area of the home page.',
			'before_widget' => '<section class="widget featurebox_footer_widget span-11 omega">',
...
function unregister_default_wp_widgets() {
	unregister_widget('COM_widget_pages'); // not sure why this is being used
...
// widget: List Pages -- modified by UFHealth in unspecified way from original
...
// widget: custom featurebox
include ('widgets/widget-featurebox.php');

// widget: custom text
include ('widgets/widget-custom-text.php');
