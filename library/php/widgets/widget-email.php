...
?>
			...
			<p><label for="<?php echo $this->get_field_id('email_to'); ?>">To Email Address(es) (separated by commas, must be @ufl.edu): <input class="widefat" id="<?php echo $this->get_field_id('email_to'); ?>" name="<?php echo $this->get_field_name('email_to'); ?>" type="text" value="<?php echo esc_attr($email_to); ?>" /></label></p>
