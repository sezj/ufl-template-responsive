...
<div class="em-booking-login">
	...
	?>	                    
	<p><a href="<?php echo site_url('wp-login.php?action=lostpassword', 'login') ?>" title="<?php esc_html_e('Password Lost and Found', 'dbem') ?>"><?php esc_html_e('Lost your password?', 'dbem') ?></a></p>
  </form>
</div>