 ...
 */
class UFCOE_EM_Widget extends WP_Widget {
	
	var $defaults;
	
    /** constructor */
    function UFCOE_EM_Widget() {
    	$this->defaults = array(
    		...
    		'limit' => 5,
    		'category' => 0,
    		'format' => '<div class="item"><div class="event-date"><span class="month">#M</span><span class="day">#d</span></div><h4>#_EVENTLINK</h4><p class="time">#_EVENTTIMES</p></div>',
    		'nolistwrap' => false,
    	...
    	$widget_ops = array('description' => __( "Display a UF theme-formatted list of events on Events Manager.", 'dbem') );
        parent::WP_Widget(false, $name = 'Events - UF Theme', $widget_ops);	
    }
...
add_action('widgets_init', create_function('', 'return register_widget("UFCOE_EM_Widget");'));
?>