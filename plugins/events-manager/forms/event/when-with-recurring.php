...
<div id="em-form-recurrence" class="event-form-recurrence event-form-when">
	...
	<p class="em-date-range">
		<span class="em-recurring-text"><?php _e ( 'Recurrence start date ', 'dbem' ); ?></span>
		<span class="em-event-text"><?php _e ( 'Event start date ', 'dbem' ); ?></span>				
		...
		<span class="em-recurring-text"><?php _e('end date','dbem'); ?></span>
		<span class="em-event-text"><?php _e('end date','dbem'); ?></span>
	...
	<p>
		...
		<span class="em-time-entry">
			...
			<input id="start-time" class="em-time-input em-time-start" type="text" size="8" maxlength="8" name="event_start_time" value="09:00 AM" /> 
			<?php _e('End time:','dbem'); ?><?php echo $required; ?>
			<input id="end-time" class="em-time-input em-time-end" type="text" size="8" maxlength="8" name="event_end_time" value="09:00 AM" />
		</span>
	</p>
