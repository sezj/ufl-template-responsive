...
?>
			<p><label for="<?php echo $this->get_field_id('url'); ?>">URL (defaults to Google Calendar URL): <input class="widefat" id="<?php echo $this->get_field_id('url'); ?>" name="<?php echo $this->get_field_name('url'); ?>" type="text" value="<?php echo esc_attr($url); ?>" /></label></p>

			<p><label for="<?php echo $this->get_field_id('title'); ?>">Title: <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></label></p>

			<p><label for="<?php echo $this->get_field_id('googleaccount'); ?>">Google Calendar ID <input class="widefat" id="<?php echo $this->get_field_id('googleaccount'); ?>" name="<?php echo $this->get_field_name('googleaccount'); ?>" type="text" value="<?php echo esc_attr($googleaccount); ?>" /></label></p>

			<p><label for="<?php echo $this->get_field_id('eventdays'); ?>">Total days of events to show<input class="widefat" id="<?php echo $this->get_field_id('eventdays'); ?>" name="<?php echo $this->get_field_name('eventdays'); ?>" type="text" value="<?php echo esc_attr($eventdays); ?>" /></label></p>

			<p><label for="<?php echo $this->get_field_id('eventcount'); ?>">Total number of events to show (trumps total days)<input class="widefat" id="<?php echo $this->get_field_id('eventcount'); ?>" name="<?php echo $this->get_field_name('eventcount'); ?>" type="text" value="<?php echo esc_attr($eventcount); ?>" /></label></p>
