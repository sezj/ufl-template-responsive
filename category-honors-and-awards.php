			...
			<article id="main-content" class="span-17" role="main">
				<div class="box">
					...
					<?php 
						...
						echo '<p class="lead">' . category_description() . ' <a href="/about/facts-figures/submit-honors-and-awards/">Submit your department\'s honors and awards</a></p>';
					?>
					...
					<?php 
 					// show subcategory posts
						...
						?>
							<h2 class="subcategory-heading"><a href="<?php echo get_category_link($sub_cat->term_id); ?>" title="View all posts filed under <?php echo $sub_cat->name; ?>"><?php echo $sub_cat->name; ?></a>&raquo;</h2>
								...
								<div class="clear">
	                				...
	                				<p class="published black-50">Published: <?php the_time('M jS, Y') ?></p>
	              					<?php the_excerpt(); ?>
	              				</div>
			 
					<?php endwhile; endif; ?>

								<p style="margin-top: -10px !important; text-align: right;"><a href="<?php echo get_category_link($sub_cat->term_id); ?>" title="<?php echo $sub_cat->name; ?>">Show all <?php echo $sub_cat->name; ?> &raquo;</a></p>
